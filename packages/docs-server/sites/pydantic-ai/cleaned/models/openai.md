...
If you want to pass parameters in code to the provider, you can programmatically instantiate the [OpenAIProvider](../../api/providers/#pydantic_ai.providers.openai.OpenAIProvider) and pass it to the model:
```
frompydantic_aiimport Agent
frompydantic_ai.models.openaiimport OpenAIChatModel
...
You can use [`OpenAIResponsesModel`](../../api/models/openai/#pydantic_ai.models.openai.OpenAIResponsesModel) by name:
```
frompydantic_aiimport Agent
...
You can then set the `DEEPSEEK_API_KEY` environment variable and use [`DeepSeekProvider`](../../api/providers/#pydantic_ai.providers.deepseek.DeepSeekProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `OLLAMA_BASE_URL` and (optionally) `OLLAMA_API_KEY` environment variables and use [`OllamaProvider`](../../api/providers/#pydantic_ai.providers.ollama.OllamaProvider) by name:
```
frompydantic_aiimport Agent
...
### Azure AI Foundry
To use [Azure AI Foundry](https://ai.azure.com/) as your provider, you can set the `AZURE_OPENAI_ENDPOINT`, `AZURE_OPENAI_API_KEY`, and `OPENAI_API_VERSION` environment variables and use [`AzureProvider`](../../api/providers/#pydantic_ai.providers.azure.AzureProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `OPENROUTER_API_KEY` environment variable and use [`OpenRouterProvider`](../../api/providers/#pydantic_ai.providers.openrouter.OpenRouterProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `VERCEL_AI_GATEWAY_API_KEY` and `VERCEL_OIDC_TOKEN` environment variables and use [`VercelProvider`](../../api/providers/#pydantic_ai.providers.vercel.VercelProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `GROK_API_KEY` environment variable and use [`GrokProvider`](../../api/providers/#pydantic_ai.providers.grok.GrokProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `MOONSHOTAI_API_KEY` environment variable and use [`MoonshotAIProvider`](../../api/providers/#pydantic_ai.providers.moonshotai.MoonshotAIProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `GITHUB_API_KEY` environment variable and use [`GitHubProvider`](../../api/providers/#pydantic_ai.providers.github.GitHubProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `FIREWORKS_API_KEY` environment variable and use [`FireworksProvider`](../../api/providers/#pydantic_ai.providers.fireworks.FireworksProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `TOGETHER_API_KEY` environment variable and use [`TogetherProvider`](../../api/providers/#pydantic_ai.providers.together.TogetherProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `HEROKU_INFERENCE_KEY` and (optionally )`HEROKU_INFERENCE_URL` environment variables and use [`HerokuProvider`](../../api/providers/#pydantic_ai.providers.heroku.HerokuProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `CEREBRAS_API_KEY` environment variable and use [`CerebrasProvider`](../../api/providers/#pydantic_ai.providers.cerebras.CerebrasProvider) by name:
```
frompydantic_aiimport Agent
...
Once you have the configs, use the [`LiteLLMProvider`](../../api/providers/#pydantic_ai.providers.litellm.LiteLLMProvider) as follows:
```
frompydantic_aiimport Agent
frompydantic_ai.models.openaiimport OpenAIChatModel
...
You can set the `NEBIUS_API_KEY` environment variable and use [`NebiusProvider`](../../api/providers/#pydantic_ai.providers.nebius.NebiusProvider) by name:
```
frompydantic_aiimport Agent
...
You can set the `OVHCLOUD_API_KEY` environment variable and use [`OVHcloudProvider`](../../api/providers/#pydantic_ai.providers.ovhcloud.OVHcloudProvider) by name:
```
frompydantic_aiimport Agent
...
#> The capital of France is Paris.
```
If you need to configure the provider, you can use the [`OVHcloudProvider`](../../api/providers/#pydantic_ai.providers.ovhcloud.OVHcloudProvider) class:
```
frompydantic_aiimport Agent
frompydantic_ai.models.openaiimport OpenAIChatModel
