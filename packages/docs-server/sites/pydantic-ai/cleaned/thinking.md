...
## OpenAI
When using the [`OpenAIChatModel`](../api/models/openai/#pydantic_ai.models.openai.OpenAIChatModel), text output inside `<think>` tags are converted to [`ThinkingPart`](../api/messages/#pydantic_ai.messages.ThinkingPart) objects. You can customize the tags using the [`thinking_tags`](../api/profiles/#pydantic_ai.profiles.ModelProfile.thinking_tags) field on the [model profile](../models/openai/#model-profile).
### OpenAI Responses
The [`OpenAIResponsesModel`](../api/models/openai/#pydantic_ai.models.openai.OpenAIResponsesModel) can generate native thinking parts. To enable this functionality, you need to set the [`OpenAIResponsesModelSettings.openai_reasoning_effort`](../api/models/openai/#pydantic_ai.models.openai.OpenAIChatModelSettings.openai_reasoning_effort) and [`OpenAIResponsesModelSettings.openai_reasoning_summary`](../api/models/openai/#pydantic_ai.models.openai.OpenAIResponsesModelSettings.openai_reasoning_summary) [model settings](../agents/#model-run-settings).
...
```
## Anthropic
To enable thinking, use the [`AnthropicModelSettings.anthropic_thinking`](../api/models/anthropic/#pydantic_ai.models.anthropic.AnthropicModelSettings.anthropic_thinking) [model setting](../agents/#model-run-settings).
...
```
## Google
To enable thinking, use the [`GoogleModelSettings.google_thinking_config`](../api/models/google/#pydantic_ai.models.google.GoogleModelSettings.google_thinking_config) [model setting](../agents/#model-run-settings).
 ...
 * `"raw"`: The thinking part is included in the text content inside `<think>` tags, which are automatically converted to [`ThinkingPart`](../api/messages/#pydantic_ai.messages.ThinkingPart) objects.
 * `"hidden"`: The thinking part is not included in the text content.
 * `"parsed"`: The thinking part has its own structured part in the response which is converted into a [`ThinkingPart`](../api/messages/#pydantic_ai.messages.ThinkingPart) object.
To enable thinking, use the [`GroqModelSettings.groq_reasoning_format`](../api/models/groq/#pydantic_ai.models.groq.GroqModelSettings.groq_reasoning_format) [model setting](../agents/#model-run-settings):
...
## Hugging Face
Text output inside `<think>` tags is automatically converted to [`ThinkingPart`](../api/messages/#pydantic_ai.messages.ThinkingPart) objects. You can customize the tags using the [`thinking_tags`](../api/profiles/#pydantic_ai.profiles.ModelProfile.thinking_tags) field on the [model profile](../models/openai/#model-profile).
## Outlines
