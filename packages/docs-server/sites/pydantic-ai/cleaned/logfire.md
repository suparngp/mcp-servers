[ Skip to content ](#pydantic-logfire-debugging-and-monitoring)
...
pipuv
```
pip"pydantic-ai-slim[logfire]"
```
```
uv"pydantic-ai-slim[logfire]"
```
...
[![Logfire Simple Agent Run](../img/logfire-simple-agent.png)](../img/logfire-simple-agent.png)
...
[![Logfire monitoring Pydantic AI](../img/logfire-monitoring-pydanticai.png)](../img/logfire-monitoring-pydanticai.png)
...
With HTTP instrumentationWithout HTTP instrumentation
...
[![otel tui simple](../img/otel-tui-simple.png)](../img/otel-tui-simple.png)
...
[![otel tui weather agent](../img/otel-tui-weather.png)](../img/otel-tui-weather.png)
