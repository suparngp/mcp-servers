[ Skip to content ](#built-in-evaluators)
# Built-in Evaluators
...
```
frompydantic_evals.evaluatorsimport Equals
...
```
frompydantic_evals.evaluatorsimport Contains
Contains(
 value='substring',
 case_sensitive=True,
 as_strings=False,
 ...
 * `evaluation_name` (str | None): Custom name for this evaluation in reports
**Returns:** [`EvaluationReason`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluationReason) - Pass/fail with explanation
**Behavior:**
 ...
 * `evaluation_name` (str | None): Custom name for this evaluation in reports
**Returns:** [`EvaluationReason`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EvaluationReason) - Pass/fail with type information
**Example:**
```
frompydantic_evalsimport Case, Dataset
frompydantic_evals.evaluatorsimport IsInstance
 ...
 * Timeout validation
**See Also:** [Concurrency & Performance](../../how-to/concurrency/)
* * *
## LLM-as-a-Judge
### LLMJudge
...
```
**See Also:** [LLM Judge Deep Dive](../llm-judge/)
* * *
...
```
**Parameters:**
 * `query` ([`SpanQuery`](../../../api/pydantic_evals/otel/#pydantic_evals.otel.SpanQuery)): Query to match against spans
 * `evaluation_name` (str | None): Custom name for this evaluation in reports
...
```
**See Also:** [Span-Based Evaluation](../span-based/)
* * *
## Quick Reference Table
Evaluator | Purpose | Return Type | Cost | Speed 
---|---|---|---|--- 
[`EqualsExpected`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.EqualsExpected) | Exact match with expected | `bool` | Free | Instant 
[`Equals`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.Equals) | Equals specific value | `bool` | Free | Instant 
[`Contains`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.Contains) | Contains value/substring | `bool` + reason | Free | Instant 
[`IsInstance`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.IsInstance) | Type validation | `bool` + reason | Free | Instant 
[`MaxDuration`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.MaxDuration) | Performance threshold | `bool` | Free | Instant 
[`LLMJudge`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.LLMJudge) | Subjective quality | `bool` and/or `float` | $$ | Slow 
[`HasMatchingSpan`](../../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.HasMatchingSpan) | Behavioral check | `bool` | Free | Fast 
 ...
 * **[Span-Based Evaluation](../span-based/)** - Using OpenTelemetry spans for behavioral checks