[ Skip to content ](#example-simple-validation)
...
"""Convert text to title case."""
 return text.title()
@pytest.fixture
deftitle_case_dataset():
 return Dataset.from_file('title_case_tests.yaml')
deftest_title_case_evaluation(title_case_dataset):
...
deftest_title_case_performance(title_case_dataset):
"""Verify performance."""
 report = title_case_dataset.evaluate_sync(to_title_case)
...
```
## Next Steps
 * **[Built-in Evaluators](../../evaluators/built-in/)** - Explore all available evaluators
 * **[Custom Evaluators](../../evaluators/custom/)** - Write your own evaluation logic
 * **[Dataset Management](../../how-to/dataset-management/)** - Save, load, and manage datasets
 * **[Concurrency& Performance](../../how-to/concurrency/)** - Optimize evaluation performance