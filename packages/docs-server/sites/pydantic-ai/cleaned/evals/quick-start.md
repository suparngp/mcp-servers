 ...
 * **[`Dataset`](../../api/pydantic_evals/dataset/#pydantic_evals.dataset.Dataset)**- A collection of test cases and (optional) evaluators
 * **[`Case`](../../api/pydantic_evals/dataset/#pydantic_evals.dataset.Case)**- A single test scenario with inputs and optional expected outputs and case-specific evaluators
 * **[`Evaluator`](../../api/pydantic_evals/evaluators/#pydantic_evals.evaluators.Evaluator)**- A function that scores or validates task outputs
 * **[`EvaluationReport`](../../api/pydantic_evals/reporting/#pydantic_evals.reporting.EvaluationReport)**- Results from running an evaluation
For a deeper dive, see [Core Concepts](../core-concepts/).
## Common Use Cases
 ...
 * **[Core Concepts](../core-concepts/)** - Understand the data model and evaluation flow
 * **[Built-in Evaluators](../evaluators/built-in/)** - Learn about all available evaluators
 ...
 * **[Examples](../examples/simple-validation/)** - Practical examples for common scenarios