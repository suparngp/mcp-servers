 ...
 * Use [`Agent.override`](../api/agent/#pydantic_ai.agent.Agent.override) to replace an agent's model, dependencies, or toolsets inside your application logic
...
fromfake_databaseimport DatabaseConn # (1)!
fromweather_serviceimport WeatherService # (2)!
weather_agent = Agent(
 'openai:gpt-5',
...
async defrun_weather_forecast( # (4)!
...
frompydantic_aiimport models, capture_run_messages, RequestUsage
