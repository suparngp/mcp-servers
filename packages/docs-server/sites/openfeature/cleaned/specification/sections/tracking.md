...
client.track("clicked-checkout", evaluationContext,newTrackingEventDetails(99.77)); 
// example tracking event recording that a subject performed an action associated with a business goal, with the tracking event details having a particular numeric value 
client.track("clicked-checkout", evaluationContext,newTrackingEventDetails(99.77).add("currencyCode","USD")); 
```
...
// example tracking event recording that a subject performed an action associated with a business goal, with the tracking event details having a particular numeric value 
client.track("clicked-checkout",newTrackingEventDetails(99.77)); 
...
client.track("clicked-checkout",newTrackingEventDetails(99.77).add("currencyCode","USD")); 
```
 ...
 * [Overview](#overview)
 * [6.1. Tracking API](#61-tracking-api)
 * [Condition 6.1.1](#condition-611)
 * [Condition 6.1.2](#condition-612)
 * [Requirement 6.1.3](#requirement-613)
 * [Requirement 6.1.4](#requirement-614)
 * [6.2. Tracking Event Details](#62-tracking-event-details)
 * [Requirement 6.2.1](#requirement-621)
 * [Requirement 6.2.2](#requirement-622)