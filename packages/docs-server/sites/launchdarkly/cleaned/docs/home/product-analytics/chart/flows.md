...
On this page
 * [Overview](#overview)
 * [Create a flows chart](#create-a-flows-chart)
## Overview
This topic explains how to create a flows chart in the product analytics **Dashboards** tab. Flows charts let you track the most common sequences of events your users perform so you can understand the different paths they take through your product.
### Create a flows chart
To create a dashboard with a flows chart:
 1. Click **New dashboard**. The “Untitled dashboard” page opens. Click the dashboard title to give it a unique name.
 2. Click **Add content** and choose the “Flows” type from the dropdown that appears. The “Events” configuration menu appears.
 3. Click in the “Events” search bar and choose an “Anchor event” to track. Optionally, specify how many steps before and steps after that event you want to track.
 4. Optionally, choose a “Goal event” to specify which events you want to see overall conversion for.
 5. Choose “Events of interest” to specify which events you want to measure that take place during the flow.
 6. Optionally, choose “Highlight events” to bring certain events to the top of the flow UI so you can track their performance.
 7. Optionally, set how many “Rows” of events you want to display.
 8. In the “Conversion criteria” menu, choose a period of time over which to track user activity in the flow.
 9. Optionally, click to expand the “Filters” menu and specify which criteria to include or exclude from the flow.
