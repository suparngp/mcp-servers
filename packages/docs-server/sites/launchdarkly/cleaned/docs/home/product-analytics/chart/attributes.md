...
On this page
 * [Overview](#overview)
 * [The Attributes tab](#the-attributes-tab)
## Overview
This topic explains how to use the product analytics **Attributes** tab, and what information that tab contains. An attribute is an attribute of the user or event that helps you analyze your data further to carry out deeper analysis. Attributes in product analytics are a subset of context attributes, specifically those associated with the `user` context. To learn more about context attributes, read [Context attributes](/docs/home/flags/context-attributes).
## The Attributes tab
Access the **Attributes** tab by clicking it from product analytics. The **Attributes** tab is displayed with multiple columns. You can search by typing in the box to find a specific attribute.
 * Attribute name: The name of the attribute.
 * Type: The type of the attribute. This is either `User` or `Event`.
 * Count of unique values: The number of times events with this attribute have been registered.
 * Example value: An example of what the attribute looks like in data.
![The Attributes tab.](https://files.buildwithfern.com/https://launchdarkly.docs.buildwithfern.com/docs/05686a8539e7dd7638b763ab90a62d5e9b568dc3a083cece9618292a857bc4c1/assets/images/__LD_UI_no_test/product-analytics-attributes.png)
The Attributes tab.
