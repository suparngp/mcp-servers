...
## Overview
This topic explains how to enable SSO for your LaunchDarkly account.
## Enable SSO
...
To enable SSO:
 ...
 4. Click **Turn on SSO**. A confirmation dialog appears.
 5. Click **Turn on**.
...
To learn more about how to remediate SAML assertion consumer errors, read [SSO SAML Error Messages](https://support.launchdarkly.com/hc/en-us/articles/14022261330459-SSO-SAML-Error-Messages).
