...
On this page
 * [Overview](#overview)
 * [View individual member roles](#view-individual-member-roles)
## Overview
This topic explains how to view roles for members in LaunchDarkly.
...
To view an individual member’s roles:
 ...
 3. Click the name of the member you want to view. The member’s **Access** tab opens.
 4. View the member’s individually assigned roles in the “Assigned directly” table.
 5. (Optional) View the roles granted to that member by teams they belong to in the “Assigned through team” table.
![](https://fern-image-hosting.s3.us-east-1.amazonaws.com/launchdarkly/openapi-logo.svg)
You can also use the REST API: [Account members](/docs/api/account-members)
