...
## Overview
This topic explains how to delete roles in LaunchDarkly.
## Delete roles
LaunchDarkly provides both project and organization [preset roles](/docs/home/getting-started/vocabulary#preset-roles). You can delete these roles, although we do not recommend it. You can also delete any role that you create. You cannot delete the [base roles](/docs/home/getting-started/vocabulary#base-role) (No access, Reader, Writer, Admin, Owner).
To delete a role:
 1. Click the **gear** icon in the left sidenav to view Organization settings.
 2. Click **Roles** and find the role you wish to review. Select the **Project** or **Organization** tab as needed.
 ...
 5. On the “Edit role” page, click **More actions**.
 6. Click **Delete role**.
...
You can also use the REST API: [Delete custom role](/docs/api/custom-roles/delete-custom-role)
