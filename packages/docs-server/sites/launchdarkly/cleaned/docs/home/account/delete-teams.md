...
## Overview
This topic explains how LaunchDarkly account members can delete teams in LaunchDarkly.
## Delete a team
You can delete teams from the **Teams** list.
To delete a team:
...
You can also use the REST API: [Delete team](/docs/api/teams/delete-team)
