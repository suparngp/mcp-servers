...
On this page
 * [Overview](#overview)
 * [Remove an account member’s role](#remove-an-account-members-role)
## Overview
This topic explains how to remove roles from members in LaunchDarkly.
## Remove an account member’s role
If an account member changes function or needs their permissions modified, you can remove a role from them at any time.
To remove a role from a member:
 ...
 3. Find the account member you wish to remove a role from.
 4. Click that account member’s name. The member’s **Access** tab opens.
 5. In the “Assigned directly” table, find the role that you want to remove.
 6. Click the **three-dot** overflow menu next to that role.
 7. Click **Remove access**.
 8. In the confirmation dialog, click **Remove access**. The member’s access is updated.
