...
The topics here explain how to enable multi-factor authentication and single sign-on in your LaunchDarkly account, how to secure connections with API access tokens, and more. You can find your account’s security settings by clicking the **gear** icon in the left sidenav, then **Security**.
 ...
 * [Single sign-on](/docs/home/account/sso)
 * [API access tokens](/docs/home/account/api)
 * [Multi-factor authentication](/docs/home/account/mfa)
 * [Domain verification](/docs/home/account/domain-verification)
 * [Managing sessions](/docs/home/account/sessions)
 * [Organization access settings](/docs/home/account/org-settings)
 * [Organization announcements](/docs/home/account/org-announcements)
 * [Support options](/docs/home/account/enhanced-support)
 * [Resetting your password](/docs/home/account/reset-password)
