...
On this page
 * [Overview](#overview)
 * [Clone and delete access tokens](#clone-and-delete-access-tokens)
## Overview
...
![A new access token and its overflow menu, including the "Clone token" and "Delete token" options.](https://files.buildwithfern.com/https://launchdarkly.docs.buildwithfern.com/docs/512590e00d9baafa9ec4821dbc9166f6edb581a9784240e051c4ee848b1a9e83/assets/images/auto/settings-access-tokens-clone-delete.auto.png)
...
You can also use the REST API: [Delete access token](/docs/api/access-tokens/delete-token)
