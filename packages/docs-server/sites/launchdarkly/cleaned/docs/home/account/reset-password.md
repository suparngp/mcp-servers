 ...
 * [You did not receive a reset email](#you-did-not-receive-a-reset-email)
## Overview
...
If you sign in to LaunchDarkly though an SSO provider, such as Okta, Google, or your organization’s SSO, you can reset your password through that provider. To learn more, read [Single sign-on](/docs/home/account/sso).
## Reset your password
If you have your current LaunchDarkly password, you can change your password from the **Profile** page under **Personal settings**. To learn more, read [Change your password](/docs/home/account/profile#change-your-password).
##### You must have your current password to reset your password while logged in
You must verify your identity by entering your existing password.
If you don’t have your current LaunchDarkly password, you can reset your password.
...
Password reset links expire after one hour. If your password reset link has expired, request a new reset link by following the instructions in [Reset your password](/docs/home/account/reset-password#reset-your-password).
...
If you are still not receiving password reset emails, [start a Support ticket](https://support.launchdarkly.com/hc/en-us/requests/new).
