...
On this page
 * [Overview](#overview)
 * [Change SSO providers](#change-sso-providers)
## Overview
This topic explains how to change SSO providers for your LaunchDarkly account.
...
Here’s how:
 1. [Disable SSO](/docs/home/account/saml/disable).
 2. [Update your SAML configuration](/docs/home/account/saml#configure-launchdarkly-saml) with the new certificate.
 3. [Enable test-drive mode](/docs/home/account/saml#test-drive-mode).
 4. Test the new SSO provider and confirm it is working as expected.
 5. (Optional) [Reconfigure your user provisioning](/docs/home/account/saml#user-provisioning-with-saml), if needed.
 6. [Re-enable SSO](/docs/home/account/saml/enable).
