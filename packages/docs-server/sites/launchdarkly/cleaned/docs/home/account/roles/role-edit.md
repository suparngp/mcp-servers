...
On this page
 * [Overview](#overview)
 * [Edit existing roles](#edit-existing-roles)
## Overview
This topic explains how to edit roles and policies in LaunchDarkly.
## Edit existing roles
You can edit any role that you have created at any time.
You can edit an existing [preset roles](/docs/home/getting-started/vocabulary#preset-roles) by adding policy statements. You can also update or remove the policy statements that you have added to these roles. You cannot update the policy statements that the preset roles include by default. To learn more about these roles, read [Organization roles](/docs/home/account/roles/organization-roles) and [Project roles](/docs/home/account/roles/project-roles).
You cannot edit any of the [base roles](/docs/home/getting-started/vocabulary#base-role) (No access, Reader, Writer, Admin, Owner).
To edit a role:
 1. Click the **gear** icon in the left sidenav to view Organization settings.
 2. Click **Roles** and find the role you wish to edit. Select the **Project** or **Organization** tab as needed.
 3. Click the name of the role. A summary of the role and its policy statements appears.
 4. Click the **pencil** icon to open the “Edit role” page.
 5. Update the role as needed.
 6. Click **Save role**.
![](https://fern-image-hosting.s3.us-east-1.amazonaws.com/launchdarkly/openapi-logo.svg)
You can also use the REST API: [Update custom role](/docs/api/custom-roles/patch-custom-role)
