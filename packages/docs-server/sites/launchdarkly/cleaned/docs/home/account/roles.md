 ...
 * [Overview](#overview)
## Overview
This category describes roles in LaunchDarkly. A role is a description of the access that a member or team has within LaunchDarkly.
In this category you can find information on the following topics:
 * [Member role concepts](/docs/home/account/roles/role-concepts), including details on working with [policies](/docs/home/account/roles/role-policies), [resources](/docs/home/account/roles/role-resources), [actions](/docs/home/account/roles/role-actions), and [role scope](/docs/home/account/roles/role-scope). This section also includes the [complete list of available actions](/docs/home/account/roles/role-actions).
 * [Managing role assignments](/docs/home/account/roles/manage-role-assignments), including information on how to assign roles to members or teams, and how to view, update, or remove roles from members or teams.
 * [Managing roles](/docs/home/account/roles/manage-roles), including details on different kinds of preset roles and information on how to create, edit, and delete roles.
