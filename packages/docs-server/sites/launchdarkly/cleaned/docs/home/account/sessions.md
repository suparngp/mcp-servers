...
On this page
 * [Overview](#overview)
 * [Configure session length](#configure-session-length)
...
Session timeout controls are on the **Security** page, in the “Session configuration” section.
To change session length:
 1. Click the **gear** icon in the left sidenav to view Organization settings.
 2. Click **Security** and scroll to the “Session configuration” section:
![Session configuration options.](https://files.buildwithfern.com/https://launchdarkly.docs.buildwithfern.com/docs/8d317dbd54cd935d00ee7e1f993da98325f5e97deb4a52fca1f4d817209a3dbb/assets/images/auto/settings-security-session-config.auto.png)
...
##### Revoking all sessions also revokes yours
If you revoke all sessions for your organization’s account members, your session will also be revoked. You will log out and have to re-authenticate.
