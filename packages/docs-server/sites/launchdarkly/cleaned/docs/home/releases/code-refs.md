...
On this page
 * [Overview](#overview)
 * [Set up code references](#set-up-code-references)
 * [Additional setup](#additional-setup)
## Overview
This topic explains how to set up code references for engineering insights.
LaunchDarkly uses code references to associate flags with code-based changes such as pull requests and deployments. These associations let LaunchDarkly calculate usage metrics and increase the accuracy of the flag health metric. To learn more, read [Flag health](/docs/home/releases/flag-health).
## Set up code references
Set up code references for each codebase in which you use flags. To learn how, read the instructions using the **Get started** button at the bottom of the screen, or by reading [Code references](/docs/home/flags/code-references).
## Additional setup
To finish setting up engineering insights, you may also need to [Send deployment information to LaunchDarkly](/docs/home/releases/config-deployment) and [Install the GitHub app](/docs/home/releases/github-app). To learn more, read [Confirm your setup](/docs/home/releases/get-started#confirm-your-setup).
