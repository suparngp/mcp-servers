...
This category includes documentation about how to run LaunchDarkly experiments using metric events from an external warehouse. Warehouse native Experimentation allows you to run experiments in LaunchDarkly and analyze them against trusted data in your external warehouse to gain deeper insights and make data-informed product decisions.
The topics in this category include:
 * [Snowflake native Experimentation](/docs/home/warehouse-native/snowflake)
 * [Warehouse native metrics](/docs/home/warehouse-native/metrics)
 * [Creating warehouse native experiments](/docs/home/warehouse-native/creating)
