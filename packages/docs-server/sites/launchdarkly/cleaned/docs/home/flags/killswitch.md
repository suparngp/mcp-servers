...
On this page
 * [Overview](#overview)
 * [About kill switch flags](#about-kill-switch-flags)
 * [Create kill switch flags](#create-kill-switch-flags)
 * [Modify the kill switch flag template](#modify-the-kill-switch-flag-template)
## Overview
...
Because kill switch or circuit breaker flags are used to shut off functionality or third-party tools completely, they typically do not use complex targeting rules. Instead, they serve “Enabled” by default when targeting is on, and “Disabled” when targeting is off. To learn more about targeting, read [Target with flags](/docs/home/flags/target).
