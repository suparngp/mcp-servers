...
On this page
 * [Overview](#overview)
 * [About experiment flags](#about-experiment-flags)
 * [Create experiment flags](#create-experiment-flags)
 * [Modify the experiment flag template](#modify-the-experiment-flag-template)
## Overview
...
Then, run experiments on the flag. To get started, click **Add experiment** the flag’s right sidebar. To learn more, read [Creating experiments](/docs/home/experimentation/create).
