...
Syncing segments from Zeotap is only available to customers on select plans. To learn more, [read about our pricing](https://launchdarkly.com/pricing/). To upgrade your plan, [contact Sales](https://launchdarkly.com/contact-sales/).
## Overview
...
Zeotap manages this integration. To learn how to use it, read Zeotap’s [LaunchDarkly](https://docs.zeotap.com/articles/#!integrate-customer/launchdarkly).
To learn more about synced segments in LaunchDarkly, read [Segments synced from external tools](/docs/home/flags/synced-segments).
