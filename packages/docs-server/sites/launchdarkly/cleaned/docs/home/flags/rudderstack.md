...
RudderStack manages this integration. To learn how to use it, read RudderStack’s [LaunchDarkly Segments](https://www.rudderstack.com/docs/destinations/audience-list-destinations/launchdarkly-segments/).
