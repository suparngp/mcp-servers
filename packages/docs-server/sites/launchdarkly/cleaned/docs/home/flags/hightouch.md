...
Hightouch manages this integration. To learn how to use it, read Hightouch’s [Syncing synced segments](https://hightouch.com/docs/destinations/launchdarkly#syncing-synced-segments).
