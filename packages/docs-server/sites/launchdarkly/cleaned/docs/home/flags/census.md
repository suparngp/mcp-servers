...
Census manages this integration. To learn how to use it, read Census’s [LaunchDarkly Synced Segments](https://docs.getcensus.com/destinations/launchdarkly#synced-segments).
