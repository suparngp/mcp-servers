...
On this page
 * [Overview](#overview)
 * [Archive context kinds](#archive-context-kinds)
 * [Restore archived context kinds](#restore-archived-context-kinds)
## Overview
...
To archive a context kind:
 ...
 3. Click the **pencil** icon next to the context kind you want to archive. The “Edit context kind” dialog appears.
 4. Click **Archive**.
...
To restore an archived context kind:
 1. Navigate to the **Contexts** list.
 2. Click the **gear** icon on the right. The context kinds list appears.
 3. Check the **Show archived context kinds** checkbox at the top of the context kinds list.
 4. Click the **pencil** icon next to the context kind you want to restore. The “Edit context kind” dialog appears.
 5. Click **Restore**.
