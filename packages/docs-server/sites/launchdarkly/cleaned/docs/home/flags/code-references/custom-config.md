...
On this page
 * [Overview](#overview)
 * [Custom ld-find-code-refs configuration](#custom-ld-find-code-refs-configuration)
...
You can also use `ld-find-code-refs` to test the flag finder before setting up an automated trigger. To learn more, read the [GitHub documentation](https://github.com/launchdarkly/ld-find-code-refs/#execution-via-cli) for `ld-find-code-refs`.
