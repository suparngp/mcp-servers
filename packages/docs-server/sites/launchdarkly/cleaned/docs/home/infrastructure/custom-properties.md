...
On this page
 * [Overview](#overview)
 * [Create a custom property type](#create-a-custom-property-type)
...
To create a custom property type:
 ...
 4. Enter the new property type name in the **Type** field.
 5. (Optional) Edit the **Key** if needed.
 6. Enter the **Values** associated with the custom property.
 7. Click **Save**.
...
To add an existing custom property to a flag:
 ...
 2. Click the **three-dot** overflow menu in the right sidebar.
 3. Select **Add custom property**.
 4. Select a property **Type** from the menu.
 5. Enter the **Values** associated with the property.
 6. Click **Save**.
