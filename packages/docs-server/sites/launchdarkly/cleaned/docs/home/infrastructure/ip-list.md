...
On this page
 * [Overview](#overview)
 * [Access LaunchDarkly through a public IP range](#access-launchdarkly-through-a-public-ip-range)
 * [Updates](#updates)
## Overview
...
If you want to configure access by domain instead, read the [Domain list](/docs/sdk/concepts/domain-list).
To learn how to obtain the IP list for just the required domains associated with a specific SDK, read [How to get IPs LaunchDarkly uses](https://support.launchdarkly.com/hc/en-us/articles/15676678468507-How-to-get-IPs-LaunchDarkly-uses).
...
You can also use the REST API: [Get the public IP list](/docs/api/other/get-ips)
