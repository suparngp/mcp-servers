...
On this page
 * [Overview](#overview)
 * [Logging in using SSO](#logging-in-using-sso)
 * [Initiating login through LaunchDarkly](#initiating-login-through-launchdarkly)
 * [Initiating login through your IdP](#initiating-login-through-your-idp)
## Overview
...
For a list of SSO providers LaunchDarkly supports, read [Supported external identity providers](/docs/home/account/sso#supported-external-identity-providers).
