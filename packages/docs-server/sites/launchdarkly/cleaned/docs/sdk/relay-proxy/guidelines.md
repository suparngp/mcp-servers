 ...
 * [Using a persistent feature store](#using-a-persistent-feature-store)
## Overview
...
To learn more about deploying and starting the Relay Proxy, read [Deploying the Relay Proxy](/docs/sdk/relay-proxy/deploying).
To learn more about performance expectations while the Relay Proxy is running, read [Monitoring the Relay Proxy](/docs/sdk/relay-proxy/monitoring).
...
To learn more, read [Persistent data stores](/docs/sdk/concepts/data-stores) and [Persistent storage](https://github.com/launchdarkly/ld-relay#persistent-storage).
