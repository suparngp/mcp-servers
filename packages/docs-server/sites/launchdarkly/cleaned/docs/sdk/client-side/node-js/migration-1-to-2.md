...
On this page
 * [Overview](#overview)
 * [Identifying Node.js versions for the 2.0 SDK](#identifying-nodejs-versions-for-the-20-sdk)
...
## Overview
This topic explains how to adapt code that currently uses a 1.x version of the [Node.js client-side SDK](/docs/sdk/client-side/node-js) to use version 2.0 or later.
...
The SDK no longer has a dependency on the `winston` logging package. You can still use `winston`, but the SDK does not load it by default. To learn more, read [Understanding changes to logging](/docs/sdk/client-side/node-js/migration-1-to-2#understanding-changes-to-logging).
