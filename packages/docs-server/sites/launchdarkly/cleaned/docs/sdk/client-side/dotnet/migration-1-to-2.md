...
On this page
 * [Overview](#overview)
 * [Identifying .NET platforms for the 2.0 SDK](#identifying-net-platforms-for-the-20-sdk)
 ...
 * [Understanding changes to custom URI configuration](#understanding-changes-to-custom-uri-configuration)
...
## Overview
This topic explains how to adapt code that currently uses a 1.x version of the [.NET client-side SDK](/docs/sdk/client-side/dotnet), previously called the Xamarin SDK, to use version 2.0 or later.
 ...
 * Provides: new features related to [JSON serialization](/docs/sdk/client-side/dotnet/migration-1-to-2#converting-objects-to-or-from-json-data).
...
Another data source option is the test data source. To learn more, read [TestData](https://launchdarkly.github.io/dotnet-client-sdk/api/LaunchDarkly.Sdk.Client.Integrations.TestData.html).
...
Most applications will never need to change the default LaunchDarkly service URIs. There are two main use cases for doing this: connecting to a [Relay Proxy](/docs/sdk/relay-proxy) instance, or connecting to a private LaunchDarkly instance.
...
1.x syntax1.x syntax, federal instance2.0 syntax2.0 syntax, federal instance
```
1
| var config = Configuration.Builder("mobile-key-123abc")
---|--- 
...
These include:
 * The SDK now supports aliasing users. To learn more, read: [Aliasing users](/docs/sdk/features/aliasing-users).
 * `LdClient.DataSourceStatusProvider` allows you to monitor the status of the connection to LaunchDarkly. To learn more, read: [Monitoring SDK status](/docs/sdk/features/monitoring).
 * The `Integrations.TestData` class provides a way to inject simulated feature flag data into the SDK for testing. To learn more, read: [Test data sources](/docs/sdk/features/test-data-sources).
