...
## Overview
This topic explains the changes in the Erlang (server-side) SDK 3.0 release and how to adapt code that uses a 2.x version of the [Erlang (server-side) SDK](https://hexdocs.pm/launchdarkly_server_sdk/index.html) to use version 3.0 or later.
