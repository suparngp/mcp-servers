...
```
1
| curl https://app.launchdarkly.com/api/v2/integration-configurations/integrationConfigurationId \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/integrations-beta/get-integration-configuration?explorer=true)
200Retrieved
```
1
| {
