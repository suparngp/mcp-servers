...
```
1
| curl -X DELETE https://app.launchdarkly.com/api/v2/projects/projectKey/flags/featureFlagKey/environments/environmentKey/workflows/workflowId \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/workflows/delete-workflow?explorer=true)
204No Content
```
1
| {}
