...
```
1
| curl -X PUT https://app.launchdarkly.com/api/v2/engineering-insights/repositories/projects \
---|--- 
2
...
| }'
```
[](/docs/api/insights-repositories-beta/associate-repositories-and-projects?explorer=true)
200Updated
```
1
| {
