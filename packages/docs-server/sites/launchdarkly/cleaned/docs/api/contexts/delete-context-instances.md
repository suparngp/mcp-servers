...
| 
3
| url = "https://app.launchdarkly.com/api/v2/projects/projectKey/environments/environmentKey/context-instances/id"
4
| 
5
...
| print(response.json())
```
[](/docs/api/contexts/delete-context-instances?explorer=true)
204No Content
```
1
| {}
