...
| print(response.json())
```
[](/docs/api/insights-deployments-beta/update-deployment?explorer=true)
200Updated
```
1
| {
...
LaunchDarkly docs
LaunchDarkly docs
Update a deployment by ID. Updating a deployment uses a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes. To learn more, read [Updates](https://launchdarkly.com/docs/api#updates). 
