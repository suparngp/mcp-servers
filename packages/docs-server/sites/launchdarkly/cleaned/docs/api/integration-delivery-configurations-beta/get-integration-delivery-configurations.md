...
```
1
| curl https://app.launchdarkly.com/api/v2/integration-capabilities/featureStore \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/integration-delivery-configurations-beta/get-integration-delivery-configurations?explorer=true)
200Retrieved
```
1
| {
