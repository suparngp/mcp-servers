...
```
1
| curl -X POST https://app.launchdarkly.com/api/v2/integration-capabilities/featureStore/projectKey/environmentKey/integrationKey/id/validate \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/integration-delivery-configurations-beta/validate-integration-delivery-configuration?explorer=true)
200Successful
```
1
| {
