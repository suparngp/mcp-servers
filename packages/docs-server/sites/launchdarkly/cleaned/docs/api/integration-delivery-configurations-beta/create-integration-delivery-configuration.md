...
| 
3
| url = "https://app.launchdarkly.com/api/v2/integration-capabilities/featureStore/projectKey/environmentKey/integrationKey"
4
| 
5
| payload = {
...
| print(response.json())
```
[](/docs/api/integration-delivery-configurations-beta/create-integration-delivery-configuration?explorer=true)
201Created
```
1
| {
