...
> Resources that are in beta are still undergoing testing and development. They may change without notice, including becoming backwards incompatible. The views API allows you to create, retrieve, and edit views, and link other resources to views.
