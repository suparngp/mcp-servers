...
| 
3
| url = "https://app.launchdarkly.com/api/v2/projects/projectKey/environments/environmentKey/mobileKey"
4
| 
5
...
| print(response.json())
```
[](/docs/api/environments/reset-environment-mobile-key?explorer=true)
200Successful
```
1
| {
