...
```
1
| curl -X DELETE https://app.launchdarkly.com/api/v2/projects/projectKey/flags/featureFlagKey/environments/environmentKey/followers/memberId \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/follow-flags/delete-flag-follower?explorer=true)
204No Content
```
1
| {}
...
The environment key
memberIdstringRequired`format: "string"`
