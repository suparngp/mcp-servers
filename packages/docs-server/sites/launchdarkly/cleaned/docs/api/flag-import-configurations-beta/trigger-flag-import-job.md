...
| 
3
| url = "https://app.launchdarkly.com/api/v2/integration-capabilities/flag-import/projectKey/integrationKey/integrationId/trigger"
4
| 
5
...
| print(response.json())
```
[](/docs/api/flag-import-configurations-beta/trigger-flag-import-job?explorer=true)
201Created
```
1
| {}
