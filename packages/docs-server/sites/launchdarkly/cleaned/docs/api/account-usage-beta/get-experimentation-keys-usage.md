...
```
1
| curl https://app.launchdarkly.com/api/v2/usage/experimentation-keys \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/account-usage-beta/get-experimentation-keys-usage?explorer=true)
200Retrieved
```
1
| {
...
experimentIdstringOptional`format: "string"`
