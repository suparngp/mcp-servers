...
```
1
| curl https://app.launchdarkly.com/api/v2/usage/evaluations/projectKey/environmentKey/featureFlagKey \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/account-usage-beta/get-evaluations-usage?explorer=true)
200Retrieved
```
1
| {
