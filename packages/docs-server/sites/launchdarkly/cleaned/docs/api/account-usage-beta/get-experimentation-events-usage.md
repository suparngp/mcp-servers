...
GET
/api/v2/usage/experimentation-events
cURL
```
1
| curl https://app.launchdarkly.com/api/v2/usage/experimentation-events \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/account-usage-beta/get-experimentation-events-usage?explorer=true)
200Retrieved
```
1
| {
...
Valid values: `environmentId`, `eventKey`, `eventKind`.
