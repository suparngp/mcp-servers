...
```
1
| curl https://app.launchdarkly.com/api/v2/usage/data-export-events \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/account-usage-beta/get-data-export-events-usage?explorer=true)
200Retrieved
```
1
| {
...
Valid values: `environmentId`, `eventKind`.
