...
GET
/api/v2/usage/observability/errors
Python
```
1
| import requests
...
| 
3
| url = "https://app.launchdarkly.com/api/v2/usage/observability/errors"
4
| 
5
...
| print(response.json())
```
[](/docs/api/account-usage-beta/get-observability-errors-usage?explorer=true)
200Retrieved
```
1
| {
