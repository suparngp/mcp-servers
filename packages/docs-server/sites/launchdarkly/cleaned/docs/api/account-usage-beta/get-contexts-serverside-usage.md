...
GET
/api/v2/usage/serverside-contexts
Python
```
1
| import requests
...
| 
3
| url = "https://app.launchdarkly.com/api/v2/usage/serverside-contexts"
4
| 
5
...
| print(response.json())
```
[](/docs/api/account-usage-beta/get-contexts-serverside-usage?explorer=true)
200Retrieved
```
1
| {
