...
GET
/api/v2/usage/observability/logs
Python
```
1
| import requests
...
| 
3
| url = "https://app.launchdarkly.com/api/v2/usage/observability/logs"
4
| 
5
...
| print(response.json())
```
[](/docs/api/account-usage-beta/get-observability-logs-usage?explorer=true)
200Retrieved
```
1
| {
