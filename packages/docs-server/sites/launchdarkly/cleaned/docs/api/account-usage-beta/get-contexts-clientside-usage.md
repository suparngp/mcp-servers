...
GET
/api/v2/usage/clientside-contexts
cURL
```
1
| curl https://app.launchdarkly.com/api/v2/usage/clientside-contexts \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/account-usage-beta/get-contexts-clientside-usage?explorer=true)
200Retrieved
```
1
| {
...
contextKindstringOptional`format: "string"`
...
anonymousstringOptional`format: "string"`
...
If specified, returns data for each distinct value of the given field. `contextKind` is always included as a grouping dimension. Can be specified multiple times to group data by multiple dimensions, one query parameter per dimension. 
