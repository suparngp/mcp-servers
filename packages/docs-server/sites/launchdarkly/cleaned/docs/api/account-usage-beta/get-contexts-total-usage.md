...
| 
3
| url = "https://app.launchdarkly.com/api/v2/usage/total-contexts"
4
| 
5
...
| print(response.json())
```
[](/docs/api/account-usage-beta/get-contexts-total-usage?explorer=true)
200Retrieved
```
1
| {
