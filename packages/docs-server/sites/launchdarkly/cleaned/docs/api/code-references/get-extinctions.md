...
```
1
| curl https://app.launchdarkly.com/api/v2/code-refs/extinctions \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/code-references/get-extinctions?explorer=true)
200Retrieved
```
1
| {
...
### Query Parameters
repoNamestringOptional`format: "string"`
Filter results to a specific repository
branchNamestringOptional`format: "string"`
