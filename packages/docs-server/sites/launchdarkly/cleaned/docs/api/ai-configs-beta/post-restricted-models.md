...
```
1
| curl -X POST https://app.launchdarkly.com/api/v2/projects/default/ai-configs/model-configs/restricted \
---|--- 
2
...
| }'
```
[](/docs/api/ai-configs-beta/post-restricted-models?explorer=true)
200Successful
```
1
| {
