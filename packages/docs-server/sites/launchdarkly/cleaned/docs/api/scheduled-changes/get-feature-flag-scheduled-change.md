...
```
1
| curl https://app.launchdarkly.com/api/v2/projects/projectKey/flags/featureFlagKey/environments/environmentKey/scheduled-changes/id \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/scheduled-changes/get-feature-flag-scheduled-change?explorer=true)
200Retrieved
```
1
| {
