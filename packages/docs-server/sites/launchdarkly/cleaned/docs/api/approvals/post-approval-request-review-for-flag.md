...
| 
3
| url = "https://app.launchdarkly.com/api/v2/projects/projectKey/flags/featureFlagKey/environments/environmentKey/approval-requests/id/reviews"
4
| 
5
| payload = {}
...
| print(response.json())
```
[](/docs/api/approvals/post-approval-request-review-for-flag?explorer=true)
200Successful
```
1
| {
...
Allowed values:approvecommentdecline
