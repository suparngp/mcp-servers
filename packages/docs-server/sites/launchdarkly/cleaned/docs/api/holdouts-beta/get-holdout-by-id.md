...
```
1
| curl https://app.launchdarkly.com/api/v2/projects/projectKey/environments/environmentKey/holdouts/id/holdoutId \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/holdouts-beta/get-holdout-by-id?explorer=true)
200Retrieved
```
1
| {
...
The environment key
holdoutIdstringRequired`format: "string"`
