...
```
1
| curl -X DELETE https://app.launchdarkly.com/api/v2/projects/default/release-policies/production-release \
---|--- 
2
...
```
[](/docs/api/release-policies-beta/delete-release-policy?explorer=true)
204No Content
```
1
| {}
