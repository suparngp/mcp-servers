...
```
1
| curl https://app.launchdarkly.com/api/v2/users/projectKey/userKey/expiring-user-targets/environmentKey \
---|--- 
2
| -H "Authorization: <apiKey>"
```
[](/docs/api/user-settings/get-expiring-flags-for-user?explorer=true)
200Retrieved
```
1
| {
