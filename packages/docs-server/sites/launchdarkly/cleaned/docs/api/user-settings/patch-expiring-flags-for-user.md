...
```
1
| curl -X PATCH https://app.launchdarkly.com/api/v2/users/projectKey/userKey/expiring-user-targets/environmentKey \
---|--- 
2
...
| }'
```
[](/docs/api/user-settings/patch-expiring-flags-for-user?explorer=true)
200Updated
```
1
| {
