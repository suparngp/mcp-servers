...
```
1
| curl -G https://app.launchdarkly.com/api/v2/engineering-insights/charts/releases/frequency \
---|--- 
2
...
```
[](/docs/api/insights-charts-beta/get-release-frequency-chart?explorer=true)
200Retrieved
```
1
| {
