...
| print(response.json())
```
[](/docs/api/insights-charts-beta/get-stale-flags-chart?explorer=true)
200Retrieved
```
1
| {
...
maintainerIdstringOptional`format: "string"`
Comma-separated list of individual maintainers to filter results.
maintainerTeamKeystringOptional`format: "string"`
