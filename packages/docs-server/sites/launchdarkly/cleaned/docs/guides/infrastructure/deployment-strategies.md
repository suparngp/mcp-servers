 ...
 * [Percentage-based releases](#percentage-based-releases)
 * [Canary releases](#canary-releases)
 * [Targeted releases](#targeted-releases)
 * [Entitlement releases](#entitlement-releases)
...
To learn more about segments, read [Segments](/docs/home/flags/segments).
## Concepts
...
To learn more about different use cases for feature flags, read [Creating flags](/docs/guides/flags/creating-flags).
...
These releases are useful when you cannot run a beta program, or there is little variation in your targeted user base. If you run a small B2B application with the same 1,000 end users, a percentage-based release is likely to give you an accurate estimate of whether the full rollout is likely to have positive or negative impact on your user base.
...
To learn more, read [Using entitlements to manage customer experience](/docs/guides/flags/entitlements).
## Post-release tasks
...
To help you know when a flag should be removed, LaunchDarkly has indicators on the **Flags** list that show whether a flag is being evaluated. Hover over the indicator to display additional details on flag evaluations in the last seven days. Flags that have been serving only one variation for at least a week may indicate that the flagged feature is fully released, and it may be safe to remove the flag.
